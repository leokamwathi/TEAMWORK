...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('comments', [
      ...
      {
        'postId': 1,
        'comment': 'This is a second comment post 1 Test.',
        'authorId': 2,
        'flaged': 'false',
        'isTest': 'true',
        createdAt: new Date(),
      ...
      {
        'postId': 2,
        'comment': 'This is a second comment post 2 Test.',
        'authorId': 1,
        'flaged': 'false',
        'isTest': 'true',
        createdAt: new Date(),
      ...
      {
        'postId': 4,
        'comment': 'This is a second comment post 3 Test.',
        'authorId': 2,
        'flaged': 'false',
        'isTest': 'true',
        createdAt: new Date(),
